...
class Church_NotificationController extends Church_BaseController
{
    ...
    {
        ?>
        <h3><?php _e('Your Information' , 'k7'); ?></h3>
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><?php _e('Address' , 'k7'); ?></th>
                <td>
                    <label for="address">
            ...
            <tr>
                <th scope="row"><?php _e('City' , 'k7'); ?></th>
                <td>
                    <label for="city">
            ...
            <tr>
                <th scope="row"><?php _e('Website' , 'k7'); ?></th>
                <td>
                    <label for="website">
            ...
            <tr>
                <th scoper="row"><label for="phone"><?php _e('Phone' , 'k7'); ?></label></th>
                <td>
    ...
    {
        $screens = array('post' , 'sermon'); // possible values: 'post', 'page', 'dashboard', 'link', 'attachment', 'custom_post_type'
