...

{
    ...
    public function ch_setShortcodePage()
    {
        $subpage = array(
            array(
                ...
                'menu_slug' => 'church_location_shortcode' ,
    ...
    public function ch_location_meta_box_display($post)
    {
        ...
        $get_data_location = get_post_meta($post->ID , 'church_localization_key' , true)[0];
        ...
        <div class="field-container">
            ...
            <div class="field">
                ...
                <input type="tel" name="location_phone" spellcheck="true" id="location_phone"
                       value="<?php echo $get_data_location['location_phone']; ?>" autocomplete="off"/>
            </div>
            <hr>
            <div class="field">
                ...
                <input type="email" name="location_email" id="location_email"
                       value="<?php echo $get_data_location['location_email']; ?>" autocomplete="off"/>
            </div>
            <hr>
            <div class="field">
                ...
                <textarea name="location_address"
                          id="location_address"><?php echo $get_data_location['location_address']; ?></textarea>
            </div>
            <?php
            //trading hours
            if (!empty(self::$location_trading_hour_days)) {
                ...
                foreach ($get_data_location as $day_key => $day_value) {

                    //dsiplay label and input
                    echo '<br>';
                    echo '<label for="location_trading_hours_' . $day_key . '">' . $day_key . '</label>';
                    echo '<input type="text" name="' . $day_key . '" id="' . $day_key . '" value="' . $day_value . '" autocomplete="off"/>';
                }
                echo '</div>';
            }
            ?>
    ...
    public function ch_save_location($post_id)
    {
        ...
        $location_trading_hours_monday = isset($_POST['location_trading_hours_monday']) ? sanitize_text_field($_POST['location_trading_hours_monday']) : '';
        $location_trading_hours_tuesday = isset($_POST['location_trading_hours_tuesday']) ? sanitize_text_field($_POST['location_trading_hours_tuesday']) : '';
        $location_trading_hours_wednesday = isset($_POST['location_trading_hours_wednesday']) ? sanitize_text_field($_POST['location_trading_hours_wednesday']) : '';
        $location_trading_hours_thursday = isset($_POST['location_trading_hours_thursday']) ? sanitize_text_field($_POST['location_trading_hours_thursday']) : '';
        $location_trading_hours_friday = isset($_POST['location_trading_hours_friday']) ? sanitize_text_field($_POST['location_trading_hours_friday']) : '';
        $location_trading_hours_saturday = isset($_POST['location_trading_hours_saturday']) ? sanitize_text_field($_POST['location_trading_hours_saturday']) : '';
        $location_trading_hours_sunday = isset($_POST['location_trading_hours_sunday']) ? sanitize_text_field($_POST['location_trading_hours_sunday']) : '';
        ...
        $data = array(
            array(
                ...
                'location_trading_hours_monday' => $location_trading_hours_monday,
                'location_trading_hours_tuesday' => $location_trading_hours_tuesday,
                'location_trading_hours_wednesday' => $location_trading_hours_wednesday,
                'location_trading_hours_thursday' => $location_trading_hours_thursday,
                'location_trading_hours_friday' => $location_trading_hours_friday,
                'location_trading_hours_saturday' => $location_trading_hours_saturday,
                'location_trading_hours_sunday' => $location_trading_hours_sunday
            )
        );
        update_post_meta($post_id , 'church_localization_key' , $data);
