...
class K7_Custom_Type_Post
{
    ...
    public static function register_message_content_type()
    {
        ...
        $labels = array(
            ...
            'parent_item_colon'     => __( 'Parent Item:', 'k7' ),
            'all_items'             => __( 'All Items', 'k7' ),
            'add_new_item'          => __( 'Add New Item', 'k7' ),
            'add_new'               => __( 'Add New', 'k7' ),
            'new_item'              => __( 'New Item', 'k7' ),
            'edit_item'             => __( 'Edit Item', 'k7' ),
            'update_item'           => __( 'Update Item', 'k7' ),
            'view_item'             => __( 'View Item', 'k7' ),
            'view_items'            => __( 'View Items', 'k7' ),
            'search_items'          => __( 'Search Item', 'k7' ),
            ...
            'uploaded_to_this_item' => __( 'Uploaded to this item', 'k7' ),
            'items_list'            => __( 'Items list', 'k7' ),
            'items_list_navigation' => __( 'Items list navigation', 'k7' ),
            'filter_items_list'     => __( 'Filter items list', 'k7' ),
