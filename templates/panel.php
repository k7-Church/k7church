...
<div class="ch-row">
  ...
  <div class="ch-col-9">
        ...
        <div class="ch-tab">
          <button class="ch-tablinks" onclick="openTabs(event, 'tab1')"><?php echo __('Recent Activity', 'k7');?></button>
          <button class="ch-tablinks" onclick="openTabs(event, 'tab2')"><?php echo __('Information', 'k7');?></button>
          <button class="ch-tablinks" onclick="openTabs(event, 'tab3')"><?php echo __('ANOTHER', 'k7');?></button>
        </div>
          ...
          <table class="ch-table">
              <tbody>
                <?php   
                  ...
                  <tr>
                      <td><strong><?php echo($comment->comment_author);?><br></strong><a href="<?php echo get_comment_link($comment->comment_ID);?>"><?php echo $comment->comment_content; ?></a></td>
                  </tr>
                  <?php endforeach;?>
              </tbody>
          </table>
        ...
        <div id="tab2" class="ch-tabcontent">
          <h3></h3>
                  ...
                  <div class="ch-body"><a href="<?php  echo $current_user->user_email; ?>"><?php  echo $current_user->user_email; ?></a>
                  </div>
              </div>
              <div class="ch-default">
                  <div class="ch-panel-heading">Website <i class=""></i>
                  </div>
                  <div class="ch-body"><a href="<?php  echo $current_user->user_url; ?>"><?php  echo $current_user->user_url; ?></a>
                  </div>
              </div>
        ...
        <div id="tab3" class="ch-tabcontent">
          ...
          <h2><?php echo __('Description','k7');?></h2>
                  <p><?php $authorDesc = the_author_meta('description'); echo $authorDesc; ?> 
                </p>
        </div>
