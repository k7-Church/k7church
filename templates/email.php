...
<a style="color: #3498DB; text-decoration: none;" href="https://www.getrevue.co/profile/brightonsmith?utm_campaign=Subscription+confirmation&amp;utm_content=profile-image&amp;utm_medium=email&amp;utm_source=confirmation" target="_blank"><h1>%SITE_NAME%</h1>
</a></td>
</tr>
<tr>
...
<div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; line-height: 24px; color: #A7ADB5;">Certifique-se de adicionar este endereço de e-mail (%comercial%) ao seu catálogo de endereços. Desta forma, você não perderá um único boletim informativo.</div>
</td>
</tr>
<tr>
<td align="center" style="padding: 0 56px 28px 56px;" valign="top">
<div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; color: #A7ADB5;">
Se você não se inscreveu, basta excluir este e-mail. Você não será inscrito se não clicar no botão de inscrição acima
</div>
</td>
</tr>
<tr>
...
&nbsp;
<a style="border: 0;" href="<?php echo URL;?>" target="_blank"><h1>%SITE_NAME%</h1></a></td>
</tr>
</tbody></table>
