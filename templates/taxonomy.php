<div class="wrap">
	<h1><?php _e( 'Taxonomy Manager', 'k7');?></h1>
	<?php settings_errors(); ?>

	<ul class="nav nav-tabs">
		<li class="<?php echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>"><a href="#tab-1"><?php _e( 'Your Taxonomies', 'k7');?></a></li>
		<li class="<?php echo isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
			<a href="#tab-2">
				<?php echo isset($_POST["edit_taxonomy"]) ? 'Edit' : 'Add' ?><?php _e( 'Taxonomy', 'k7');?>
			</a>
		</li>
	...
	<div class="tab-content">
		<div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
			...
			<h3><?php _e( 'Manage Your Custom Taxonomies', 'k7');?></h3>

			<?php 
				$options = get_option( 'church_plugin_tax' ) ?: array();

				echo '<table class="cpt-table"><tr><th>'. __( 'ID', 'k7'). '</th><th>'.__( 'Singular Name', 'k7'). '</th><th class="text-center">'. __( 'Hierarchical', 'k7'). '</th><th class="text-center">'.  __( 'Actions', 'k7'). '</th></tr>';
				...
				foreach ($options as $option) {
					...
					submit_button( 'Delete', 'delete small', 'submit', false, array(
						'onclick' => 'return confirm("' . __( "Are you sure you want to delete this Custom Taxonomy? The data associated with it will not be deleted", "k7") .'" );'
					));
					echo '</form></td></tr>';
				}
		...
		<div id="tab-3" class="tab-pane">
			<h3><?php _e( 'Export Your Taxonomies', 'k7');?></h3>
