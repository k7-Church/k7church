<div class="wrap">
    <h1><?php _e('CPT Manager', 'k7-church'); ?></h1>
    <?php settings_errors(); ?>

    <ul class="nav nav-tabs">
        <li class="<?php echo !isset($_POST["edit_post"]) ? 'active' : '' ?>"><a
                    href="#tab-1"><?php _e('Your Custom Post Types', 'k7-church'); ?></a></li>
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_post"]) ? 'active' : '' ?>">
            ...
            <h3><?php _e('Manage Your Custom Post Types', 'k7-church'); ?></h3>

            <?php
            $options = get_option('church_plugin_cpt') ?: array();

            echo '<table class="cpt-table"><tr><th>' . __("ID", "k7-church") . '</th><th>' . __("Singular Name", "k7-church") . '</th><th>' . __("Plural Name", "k7-church") . '</th><th class="text-center">' . __("Public", "k7-church") . '</th><th class="text-center">' . __("Archive", "k7-church") . '</th><th class="text-center">' . __("Actions", "k7-church") . '</th></tr>';
            ...
            foreach ($options as $option) {
                ...
                submit_button('Delete', 'delete small', 'submit', false, array(
                    'onclick' => 'return confirm("' . __("Are you sure you want to delete this Custom Post Type? The data associated with it will not be deleted.", "k7-church") . '" );'
                ));
                echo '</form></td></tr>';
            }
        ...
        <div id="tab-3" class="tab-pane">
            <h3><?php _e('Export Your Custom Post Types', 'k7-church'); ?></h3>
