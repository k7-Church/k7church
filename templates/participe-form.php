...
<header class="header">
    <button class="ch-tab" style="background:<?php echo esc_attr( get_option('church_background_color_button_show_form')); ?>; color:<?php echo esc_attr( get_option('church_text_color_button_show_form')); ?>;" onclick="myFunction()"><?php esc_html_e( 'Complete the form to register for this event!', 'k7-church' );?></button>
</header>
...
<form id="church-participant-form" style="display: none;" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
    ...
    <div class="field-container">
        ...
        <textarea name="message" id="message" class="field-input"
                  placeholder="<?php esc_attr_e('Your Message', 'k7-church') ?>" ></textarea>
        <small class="field-msg error" data-error="invalidMessage"><?php _e('A Message is Required', 'k7-church') ?></small>
    </div>
    ...
    <div class="field-container">
        <div>
            <button type="stubmit" class="btn btn-default btn-lg btn-sunset-form"><?php esc_html_e('Submit','k7-church');?></button>
        </div>
        <br>
        <small class="field-msg js-form-submission"><?php apply_filters( 'participant_form_submission_process_wait', _e('Submission in process, please wait&hellip;', 'k7-church') ) ?></small>
        <br>
        <small class="field-msg success js-form-success"><?php apply_filters( 'participant_form_successfully_submitted_thank', _e('Message Successfully submitted, thank you!<br><h4>Your request is awaiting approval by the organizers.</h4></p>', 'k7-church') ); ?></small>
        <small class="field-msg error js-form-error"><?php apply_filters('participant_form_error', _e('There was a problem with the Contact Form, please try again!', 'k7-church')); ?></small>
